...
<link rel="stylesheet" href="{{ asset('css/cms/pages/_counter.css') }}">
<link rel="stylesheet" href="{{ asset('css/cms/pages/_spacing.css') }}">
<link rel="stylesheet" href="{{ asset('css/cms/pages/_reboot.css') }}">
        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2 class="page-title wow fadeInUp">Event</h2>
...
<div class="concept-container container mx-auto pt-5">
  <div class="title-top" style="text-align:center;letter-spacing: 5px;">
    <h1 class="f-carneval text-black wow fadeInUp"><b>KONSEP BESAR STARLIGHT 2020</b></h1>
  </div>
  <div class="content-1">
    <div class="about-stars mt-4 wow fadeInUp" style="text-align:center;">
  ...
  <div class="splide-body mt-5 cursor-grab">
    <div class="splide">
      <div class="splide__track">
        <ul class="splide__list wow fadeInUp">
  ...
  <div class="content-2 mt-5">
    <div class="about-stars-2 wow fadeInUp" style="text-align:center;">
          ...
          <div class="row align-items-center">
              <div class="col-12 col-md-3 text-center mb-3">
                  ...
                  <div class="countdown-content-text mb-10" data-wow-delay="300ms">
                      <h6>Main Event</h6>
                      <h4 style="color: #270000">Count Every Second Until The Main Event</h4>
                  </div>
              </div>
